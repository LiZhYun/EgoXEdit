#!/bin/bash
#SBATCH --job-name=video_generation_no_club
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=./output/output_no_club.out
#SBATCH --error=./output/error_no_club.err
...
srun accelerate launch --config_file examples/wanvideo/model_training/full/accelerate_config_14B.yaml examples/wanvideo/model_training/train_E.py \
    ...
    --output_path "./models/train/Wan2.1-VACE-E-1.3B_full_no_club" \
    --learning_rate "1e-5" \
    --num_epochs 5 \
    --num_frames 81 \
    --height 480 \
